        ...
        $.each(appointment, function (key, item) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    contenido += '<button type="button" id=btnViewAppointment class="btn" onclick="viewAppointmentProfessor(' + item.Id + ')">See</button>';
                    contenido += '</li>';
    ...
    $.getJSON('/Course/GetAppointmentById/', { id }, function (appointment, textStatus, jqXHR) {
        ...
        $.ajax({
            ...
            success: function (student) {
                ...
                content += '</br>';
                content += '<button type="button" id="btnAcceptApointment" class="btn" onclick="acceptAppointment(' + appointment.Id + ')">Aceppt</button>';
