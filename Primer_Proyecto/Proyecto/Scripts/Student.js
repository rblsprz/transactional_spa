...
function deleteStudent(id) {
    var alert = confirm("Are you sure you want to delete the record?");
        ...
        success: function (result) {
            ...
            $.each(result, function (key, item) {
                data = [
                    ...
                    item.LastName,
                    item.Mail,
                    '<td><a href="#" onclick="StudentApproval(' + item.Id + ')">Pass</a> | <a href="#" onclick="StudentDeny(' + item.Id + ')">Reject</a></td>'
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result, function (key, item) {
                ...
                html += '<td><a href="#" onclick="return publicConsultation(' + item.CourseId + ',' + item.ProfessorId + ')">Public Consultation</a> | <a href="#" onclick="privateConsultation(' + item.CourseId + ',' + item.ProfessorId + ',' + item.StudentId + ')">Private Consultation</a> | <a href="#" onclick="appointment(' + item.CourseId + ',' + item.ProfessorId + ',' + item.StudentId + ')">Attention appointment</a></td>';
            });
        ...
        $.each(privateMessage, function (key, message) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    contenido += '<button type="button" id=btnPrivateConsultation class="btn" onclick="viewMessage(' + message.Id + ')">View</button>';
                    contenido += '</li>';
        ...
        $.each(appointment, function (key, item) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    contenido += '<span>' + item.DateTime + '</span>';
                    contenido += '<button type="button" class="btn" id="btnViewAppointment" onclick="viewAppointment(' + item.Id + ')">View</button>';
                    contenido += '</li>';
